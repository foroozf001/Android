...
public class MainActivity extends AppCompatActivity implements RecyclerView.OnItemTouchListener, BucketListItemListener {
    ...
    private void initRecyclerView() {
        ...
        gestureDetector = new GestureDetector(this, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onSingleTapUp(MotionEvent e) {
                ...
                if (child != null) {
                    int adapterPosition = rvBucketList.getChildAdapterPosition(child);
                    onBucketListItemClick(bucketList.get(adapterPosition));
                }
    ...
    private void updateBucketListItem(final BucketListItem item) {
        executor.execute(new Runnable() {
            @Override
            public void run() {
                db.bucketListItemDao().updateBucketListItem(item);
                getAllBucketListItems();
            }
        });
    }
    ...
    @Override
    public void onBucketListItemClick(BucketListItem item) {
